...
import com.example.josh.lists.AlbumList.AlbumListActivity;
...
public class ArtistListActivity extends ActionBarActivity implements LoaderManager.LoaderCallbacks<List<IArtist>>, ExpandableListView.OnChildClickListener {
    ...
    /*
    private ArrayAdapter<IArtist> _listAdapter;
    private static Library _library = new Library();
    private Client _client;

    public static Library Library() { return _library;}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listview = (ListView) findViewById(R.id.artist_listview);

        _listAdapter = new ArrayAdapter<IArtist>(this, android.R.layout.simple_list_item_1);
        listview.setAdapter(_listAdapter);
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
                                    ...
                                    int position, long id)
            {
                ...
                Intent intent = new Intent(ArtistListActivity.this, AlbumListActivity.class);
                intent.putExtra(AlbumListActivity.ARTIST_ID, artist.GetId());
                startActivity(intent);
            }
        });
    }
